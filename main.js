...
const MODE_DESC = {
  ...
  combo:   { title: '🎯 AI 조합 최적화', text: '실제 통계 기반 홀짝 비율(3:3 약 34% · 4:2 약 27% · 2:4 약 22%)로 가중 선택 후, 저고 비율(1~22 / 23~45), 합계값(100~170), 끝수 중복(2개 이하) 조건을 추가 적용합니다. 극단 조합(6홀 · 6짝)은 자동 제외됩니다.' },
};
